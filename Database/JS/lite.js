questions = [
    {
        ...
        answers: [
            { text: "A full-fledged relational database management system", correct: false},
            { text: "IA lightweight, embedded database engine", correct: true },
            { text: "A NoSQL database", correct: false },
            { text: "A cloud-based database", correct: false },
        ]
    },
    {
    ...
    {
        question: "What is the purpose of a primary key in a SQLite table?",
        answers: [
    ...
    {
        question: "How do you create a foreign key constraint in SQLite?",
        answers: [
    ...
    {
        question: "What is the difference between a JOIN and a UNION operation in SQLite?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { text: "A database triggers an action", correct: true },
            { text: "A view whose data is precomputed and stored", correct: true },
        ]
    },
    {
        question: "How do you create an index in SQLite?",
        answers: [
    ...
    {
        question: "What is the purpose of the VACUUM command iN SQLite?",
        answers: [
            { text: " To create a backup of the database  ", correct: false},
            { text: "To optimize the database for performance", correct: true },
            { text: "To delete unused data ", correct: false },
            { text: "To delete unused data ", correct: false },
        ]
    }
];
