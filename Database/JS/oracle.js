const questions = [
    {
        question: "What is the default data type for a column in an Oracle table?",
        answers: [
    ...
    {
        question: "Which SQL statement is used to create a new database in Oracle?",
        answers: [
            { text: "CREATE TABLE", correct: false},
            { text: " CREATE DATABASE", correct: false },
            { text: "CREATE SCHEMA", correct: true },
            { text: "CREATE INDEX", correct: false },
        ]
    },
    {
        question: "How do you select all columns and rows from a table named \"employees\" in Oracle?",
        answers: [
            { text: "SELECT * FROM employees", correct: true },
            { text: "SELECT employees FROM *", correct: false },
            { text: "SELECT employees", correct: false },
            { text: "FROM employees SELECT *", correct: false },
        ]
    },
    {
        question: "Which SQL statement is used to insert a new row into a table in Oracle?",
        answers: [
    ...
    {
        question: "What is the purpose of a primary key in an Oracle table?",
        answers: [
    ...
    {
        question: "How do you create a foreign key constraint in Oracle?",
        answers: [
    ...
    {
        question: "What is the difference between a JOIN and a UNION operation in Oracle?",
        answers: [
    ...
    {
        question: "How do you create an index in Oracle?",
        answers: [
            ...
            { text: "Niether a nor b", correct: false },
        ]
    },
    {
        question: "What is the purpose of the EXPLAIN PLAN command in Oracle?",
        answers: [
            { text: "To explain the structure of a table", correct: false},
            { text: "To explain the syntax of an SQL statement", correct: false },
            { text: "To explain the execution plan of an SQL statement ", correct: true },
