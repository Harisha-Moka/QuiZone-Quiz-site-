const questions = [
    {
        question: "What is the default data type for a column in a MySQL table?",
        answers: [
    ...
    {
        question: "How do you select all columns and rows from a table named \"customers\"?",
        answers: [
    ...
    {
        question: "What is the purpose of a primary key in a MySQL table?",
        answers: [
    ...
    {
        question: "How do you create a foreign key constraint in MySQL?",
        answers: [
    ...
    {
        question: "What is the difference between a JOIN and a UNION operation in MySQL?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "A precompiled SQL statement", correct: true },
